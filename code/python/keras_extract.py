...
if __name__ == '__main__':
    ...
    # models['xception'] =    appl.xception.Xception(weights=None, include_top=False,pooling='avg')
    # models['vgg16'] =       appl.vgg16.VGG16(weights=None, include_top=False,pooling='avg')
