...
public class DenseNet169_Byte implements KerasFeature{

    private final String featureName    = "DenseNet169_Byte";
    private final String fieldName      = "DenseNet169_Byte";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public DenseNet169_Byte(){
    }

    public DenseNet169_Byte(String csvFilename){
