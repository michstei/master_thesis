...
public class DenseNet169_Short implements KerasFeature{

    private final String featureName    = "DenseNet169_Short";
    private final String fieldName      = "DenseNet169_Short";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public DenseNet169_Short(){
    }

    public DenseNet169_Short(String csvFilename){
