...
public class InceptionV3_Float implements KerasFeature{

    private final String featureName    = "InceptionV3_Float";
    private final String fieldName      = "InceptionV3_Float";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;

    public InceptionV3_Float(){
    }

    public InceptionV3_Float(String csvFilename){
