...
public class DenseNet201_Short implements KerasFeature{

    private final String featureName    = "DenseNet201_Short";
    private final String fieldName      = "DenseNet201_Short";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public DenseNet201_Short(){
    }
    public DenseNet201_Short(String csvFilename){
