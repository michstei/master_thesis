...
public class VGG16_Float implements KerasFeature{

    private final String featureName    = "VGG16_Float";
    private final String fieldName      = "VGG16_Float";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public VGG16_Float(){
    }

    public VGG16_Float(String csvFilename){
