...
public class ResNet50_Long implements KerasFeature{

    private final String featureName    = "ResNet50_Long";
    private final String fieldName      = "ResNet50_Long";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public ResNet50_Long(){
    }
    public ResNet50_Long(String csvFilename){
