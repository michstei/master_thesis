...
public class DenseNet121_Byte implements KerasFeature{

    private final String featureName    = "DenseNet121_Byte";
    private final String fieldName      = "DenseNet121_Byte";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public DenseNet121_Byte(){
    }
    public DenseNet121_Byte(String csvFilename){
