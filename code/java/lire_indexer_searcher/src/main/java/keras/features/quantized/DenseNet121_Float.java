...
public class DenseNet121_Float implements KerasFeature{

    private final String featureName    = "DenseNet121_Float";
    private final String fieldName      = "DenseNet121_Float";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public DenseNet121_Float(){
    }
    public DenseNet121_Float(String csvFilename){
