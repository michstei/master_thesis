...
public class ResNet50_Int implements KerasFeature{

    private final String featureName    = "ResNet50_Int";
    private final String fieldName      = "ResNet50_Int";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public ResNet50_Int(){
    }
    public ResNet50_Int(String csvFilename){
