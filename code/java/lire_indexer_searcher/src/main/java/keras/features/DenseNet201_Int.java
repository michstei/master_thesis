...
public class DenseNet201_Int implements KerasFeature{

    private final String featureName    = "DenseNet201_Int";
    private final String fieldName      = "DenseNet201_Int";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public DenseNet201_Int(){
    }
    public DenseNet201_Int(String csvFilename){
