...
public class VGG19_Float implements KerasFeature{

    private final String featureName    = "VGG19_Float";
    private final String fieldName      = "VGG19_Float";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public VGG19_Float(){
    }
    public VGG19_Float(String csvFilename){
