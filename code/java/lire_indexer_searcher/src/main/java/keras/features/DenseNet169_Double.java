...
public class DenseNet169_Double implements KerasFeature{

    private final String featureName    = "DenseNet169_Double";
    private final String fieldName      = "DenseNet169_Double";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public DenseNet169_Double(){
    }

    public DenseNet169_Double(String csvFilename){
