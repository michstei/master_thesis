...
public class VGG19_Double implements KerasFeature {

    private final String featureName    = "VGG19_Double";
    private final String fieldName      = "VGG19_Double";
    public static DistanceFunction USED_DISTANCE_FUN = DistanceFunction.DISTANCEFUNCTION_COSINE;
    public VGG19_Double(){
    }
    public VGG19_Double(String csvFilename){
